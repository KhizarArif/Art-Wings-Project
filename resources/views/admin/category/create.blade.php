                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="slug" id="slug" value="{{ isset($category->slug)?$category->slug:'' }}" 
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="validationCustom03" name="show_on_home" required>
                                        ...
                                        <option value="Yes" {{  isset($category->showOnHome) && $category->showOnHome == 'Yes' ? 'selected' : '' }}>Yes</option>
                                        <option value="No" {{ isset($category->showOnHome) &&  $category->showOnHome == 'No' ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                            </div>
                        </div>
