            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="custom-validation" novalidate id="subCategoryForm">
                        @csrf
                        <input type="hidden" name="id" value="{{ isset($subCategory->id)?$subCategory->id:'' }}" id="id">
                        <input type="hidden" name="category_id" value="{{ isset($subCategory->category_id)?$subCategory->category_id:'' }}" id="category_id">

                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="validationCustom01" class="form-label">Name</label>
                                    <input type="text" class="form-control" name="name" id="name" value="{{ isset($subCategory->name)?$subCategory->name:'' }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="slug" id="slug" value="{{ isset($subCategory->name)?$subCategory->name:'' }}"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="validationCustom03" name="status" required>
                                        ...
                                        <option value="active" {{ isset($subCategory->status) && $subCategory->status == 'active' ? 'selected' : ''}} > Active </option>
                                        <option value="inactive" {{ isset($subCategory->status) && $subCategory->status == 'inactive' ? 'selected' : ''}}> InActive </option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="validationCustom03" name="show_on_home" required>
                                        ...
                                        <option value="yes" {{ isset($subCategory->showHome) && $subCategory->showHome == 'yes' ? 'selected' : ''}}>Yes</option>
                                        <option value="no" {{ isset($subCategory->showHome) && $subCategory->showHome == 'no' ? 'selected' : ''}}>No</option>
                                    </select>
                                </div>
                            </div>
                        </div>
